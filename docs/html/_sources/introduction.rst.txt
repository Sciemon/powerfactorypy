...
Plotting also requires many lines with the native API (to add the variable to the monitored variables, create a 
...
The module is at an early stage. Contributions (code, bug reports, feature request, etc.) are very welcome on Github. 
